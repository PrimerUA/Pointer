...
public class TestActivity extends Activity {
    ...
    private void addMockData() {
        ...
        values.put(ProposalTable.LONGITUDE_COLUMN, 46.461111);
        values.put(ProposalTable.LATITUDE_COLUMN, 30.707346);
        ...
        values.put(ProposalTable.LONGITUDE_COLUMN, 46.457434);
        values.put(ProposalTable.LATITUDE_COLUMN, 30.681940);
        Log.d("KVEST_TAG", "add=" + getContentResolver().insert(PointerProviderMetadata.PROPOSAL_ITEMS_URI, values).toString());
        ...
        values.put(ProposalTable.LONGITUDE_COLUMN, 46.447112);
        values.put(ProposalTable.LATITUDE_COLUMN, 30.693098);
        Log.d("KVEST_TAG", "add=" + getContentResolver().insert(PointerProviderMetadata.PROPOSAL_ITEMS_URI, values).toString());
        ...
        values.put(ProposalTable.LONGITUDE_COLUMN, 46.442840);
        values.put(ProposalTable.LATITUDE_COLUMN, 30.703741);
        Log.d("KVEST_TAG", "add=" + getContentResolver().insert(PointerProviderMetadata.PROPOSAL_ITEMS_URI, values).toString());
        ...
        values.put(ProposalTable.LONGITUDE_COLUMN, 46.466568);
        values.put(ProposalTable.LATITUDE_COLUMN, 30.687433);
        Log.d("KVEST_TAG", "add=" + getContentResolver().insert(PointerProviderMetadata.PROPOSAL_ITEMS_URI, values).toString());
    }
}
